...
The debug module can implement optional halt-on-reset bits for each hart,
which it indicates by setting \Fhasresethaltreq to 1.
This means the debugger implements the \Fsetresethaltreq and \Fclrresethaltreq bits.
...
whether or not the hart's reset is caused by the debugger's
